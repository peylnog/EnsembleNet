...
from net.model import refineNet_2Net as refine
...
parser.add_argument("--startweights", default= 303, type=int, help="start number of net's weight , 0 is None")
parser.add_argument("--initmethod", default='xavier', type=str, help="xavier , kaiming , normal ,orthogonal ,default : xavier")
parser.add_argument("--startepoch", default=310, type=int, help="Manual epoch number (useful on restarts)")
